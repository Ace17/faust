...
{
  Tree w;
  return isTree(t, BOXSLOT, w);
}

bool isBoxSlot(Tree t, int* id)
{
  Tree w;
  return isTree(t, BOXSLOT, w) && isInt(w->node(), id);
}
...
{
  return tree(BOXINPUTS, x);
}

Tree boxOutputs(Tree x)
{
  return tree(BOXOUTPUTS, x);
}

bool isBoxInputs(Tree t, Tree& x)
{
  return isTree(t, BOXINPUTS, x);
}

bool isBoxOutputs(Tree t, Tree& x)
{
  return isTree(t, BOXOUTPUTS, x);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM0, t);
}

bool isBoxPrim0(Tree s, prim0* p)
{
  Tree t;
  return isTree(s, BOXPRIM0, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM1, t);
}

bool isBoxPrim1(Tree s, prim1* p)
{
  Tree t;
  return isTree(s, BOXPRIM1, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM2, t);
}

bool isBoxPrim2(Tree s, prim2* p)
{
  Tree t;
  return isTree(s, BOXPRIM2, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM3, t);
}

bool isBoxPrim3(Tree s, prim3* p)
{
  Tree t;
  return isTree(s, BOXPRIM3, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM4, t);
}

bool isBoxPrim4(Tree s, prim4* p)
{
  Tree t;
  return isTree(s, BOXPRIM4, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t;
  return isTree(s, BOXPRIM5, t);
}

bool isBoxPrim5(Tree s, prim5* p)
{
  Tree t;
  return isTree(s, BOXPRIM5, t) && isPointer(t->node(), (void**)p);
}
...
{
  Tree t, n, f;
  return isTree(s, BOXFCONST, t, n, f);
}
...
{
  Tree lbl, params;
  return isTree(s, BOXHSLIDER, lbl, params);
}
...
{
  Tree lbl, params;
  return isTree(s, BOXVSLIDER, lbl, params);
}
...
{
  Tree lbl, params;
  return isTree(s, BOXNUMENTRY, lbl, params);
}
